...
def mycp(source,toPath):
    cp( os.path.join(source,"lib"), os.path.join(toPath ,"tag-lang-loader/lib"))
    cp( os.path.join(source,"src"), os.path.join(toPath ,"tag-lang-loader/src"))
    shutil.copyfile( os.path.join( source,"package.json"), os.path.join(toPath ,"tag-lang-loader/package.json"))
