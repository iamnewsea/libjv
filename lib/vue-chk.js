    ...
    Object.defineProperty(HTMLElement.prototype, "chk", {
        ...
        value: function value(chk_show) {
            ...
            var chk_item = function chk_item(chk_dom, inputDom) {
                ...
                chk = chk.trim();
                if (!chk) return "";
                var chk_error_msg = chk_dom.dataset.chkMsg || chk_dom.getAttribute("chk-msg") || chk_dom.getAttribute("placeholder") || "请检查输入值";
                ...
                if (chk_type == ":") {
                    ...
                    if (chk_type in _vueInit2.default.chk_types) {
                        ...
                        if (!chk_msg && chk_body) {
                            // chk_body.split("&")
                            var ret = _vueInit2.default.chk_range(chk_type, chk_body, value);
                            if (ret === false) {
                                return chk_error_msg;
                            }
            ...
            try {
                for (var _iterator = list[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    if (_vueInit2.default.chk_error) {
                        _vueInit2.default.chk_error(chk_error_obj);
                    } else {
                        _vueInit2.default.error(chk_msg, "", chk_error_obj);
                    }
