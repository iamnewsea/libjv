...
(function () {
    ...
    Object.defineProperty(HTMLElement.prototype, "chk", {
        ...
        value: function value(chk_show) {
            if (_vueInit2.default.chk_ing) {
                _vueInit2.default.chk_ing();
            }
            ...
            var getVueModel = function getVueModel(component) {
                ...
                if (vdata && vdata.model && vdata.model.expression) {
                    ...
                    ret = _vueInit2.default.evalExpression(data, vdata.model.expression);
                    if (ret.ok) {
            ...
            var chk_item = function chk_item(chk_dom, inputDom, vueModel) {
                ...
                if (chk_type == ":") {
                    ...
                    var r2 = _vueInit2.default.chk_types[chk_type](chk_body, value, chk_dom);
            ...
            try {
                for (var _iterator2 = list[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    if (chk_result.result) {
                        _vueInit2.default.chk_clear && _vueInit2.default.chk_clear({ target: inputDom, vueModel: vueModel, chk_dom: chk_dom });
                        continue;
                    }
                    ...
                    if (_vueInit2.default.chk_error) {
                        if (_vueInit2.default.chk_error(chk_result) === false) {
                            break;
                        }
                    }
