...
_vueInit2.default.chk_range = function (chk_type, chk_body, value, prevResult) {
...
_vueInit2.default.chk_types = {
  ...
  value: function value(chk_show) {
    ...
    var getVModelValue = function getVModelValue(dom) {
      var ret;
    ...
    var inputChanged = function inputChanged(e) {
      ...
      if (chk_msg) {} else if (chk_type == ":") {
        ...
        //如果定义了 * 号,表示必填.
        if (chk_type && !(chk_type in _vueInit2.default.chk_types)) {
          chk_type = Object.keys(_vueInit2.default.chk_types).find(function (it) {
        ...
        if (_vueInit2.default.chk_types[chk_type]) {
