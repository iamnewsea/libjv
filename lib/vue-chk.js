...
(function () {
    ...
    Object.defineProperty(HTMLElement.prototype, "chk", {
        ...
        value: function value(chk_show) {
            ...
            var chk_item = function chk_item(chk_dom, inputDom) {
                ...
                if (chk_type == ":") {
                    ...
                    var r2 = _vueInit2.default.chk_types[chk_type](chk_body, value, inputDom, chk_dom);
            ...
            try {
                for (var _iterator = list[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    if (chk_result.result) {
                        _vueInit2.default.chk_clear && _vueInit2.default.chk_clear({ target: inputDom, chk_dom: chk_dom });
                        continue;
                    }
                    ...
                    if (_vueInit2.default.chk_error) {
                        if (_vueInit2.default.chk_error(chk_error_obj) === false) {
                            break;
                        }
                    } else if (_vueInit2.default.error) {
                        if (_vueInit2.default.error(chk_result.msg, "校验失败", null, chk_result) === false) {
                            break;
                        }
                    }
