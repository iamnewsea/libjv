...
_vueInit2.default.chk_show = function () {};
...
_vueInit2.default.chk_types = {
  ...
  "reg": function reg(chk_body, value, inputDom) {
    if (chk_body[0] != ":") {
  ...
  value: function value(chk_show) {
    ...
    var inputChanged = function inputChanged(e) {
      ...
      if (chk_type == ":") {
        ...
        if (_vueInit2.default.chk_types[chk_type](chk_body, value, inputDom, item) == false) {
      ...
      e.chk_msg = chk_msg;
      _vueInit2.default.chk_show(chk_msg, inputDom, item);
