...
_libjv2.default.initApp = function (vue) {
    ...
    Object.defineProperty(vueProtype, "chk", {
        value: function value(chk_show) {
            return _libjv2.default.chk_vue_dom(this, chk_show);
        },
        enumerable: false
    });
...
_libjv2.default.initAxios = function (axios) {
    ...
    axios.interceptors.response.use(function (response) {
        ...
        if (json && json.msg) {
            ...
            return Promise.reject({ config: response.config, request: response.request, response: response, message: json.msg });
        }
        ...
        if (!error.response) {
            _libjv2.default.error("错误:" + JSON.stringify(error), "", "ajax");
            return Promise.reject(error);
        }
        ...
        if (status == 403) {
            _libjv2.default.error("由于系统的权限限制，禁止您的访问", "", "ajax");
            return Promise.reject(error);
        }
        if (status == 404) {
            _libjv2.default.error("找不到请求！", "", "ajax");
            return Promise.reject(error);
        }
        ...
        _libjv2.default.error(errorMsg.slice(0, 100), "", "ajax");
        return Promise.reject(error);
    });
